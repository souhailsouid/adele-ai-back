/**
 * Handler Lambda pour routes IA lourdes (15-30s)
 * Routes : institution-moves-analysis, ticker-activity-analysis, options-flow-analysis
 */

import { APIGatewayProxyHandlerV2 } from "aws-lambda";
import { findRoute } from "../router-ai-heavy";
